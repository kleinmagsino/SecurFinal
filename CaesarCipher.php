...
<h1> Caeasar's Cipher </h1>
<form action="CaesarCipher.php" method="POST">
<table>
	<table>
	<tr>
	<td>Enter word to Encrypt:<td></center><input name=user required>
	<td>Enter Key:<td><input name=key required>
	</tr>
	<tr>
	<td colspan=2><center><input type=submit  name=Encrypt value=Decipher>
	</tr>
</table>
